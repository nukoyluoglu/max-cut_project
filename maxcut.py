...
def runtime(algorithm, radius):
    SETUP_CODE = '''
maxcut_problem = problem.SpinLattice(LATTICE_X, LATTICE_Y, LATTICE_SPACING)
interaction_fn = problem.logistic_decay_fn(INTERACTION_AMPLITUDE, radius)
...
def main(plot=True):
    ...
    util.plot_interaction(problem.logistic_decay_fn(INTERACTION_AMPLITUDE, 30), 30)
